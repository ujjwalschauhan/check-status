...
<body>
    <nav class="navbar">
            ...
            <a class="signup-time"><?php echo (date("d-m-Y"));?></a>
    </nav>
    <div class="container">
        <div class="row">
            <div class="col-md-4 offset-md-4 form">
                <form action="signup-user.php" method="POST" autocomplete="">
                    <h2 class="text-center" id="signup-h2">Signup Form</h2>
                    <?php
                    if(count($errors) == 1){
                        ?>
                    ...
                    <div class="link login-link text-center" id="signup-h2">Already registered? <a href="login-user.php">Login here</a></div>
                </form>
            </div>
        </div>
    </div>
